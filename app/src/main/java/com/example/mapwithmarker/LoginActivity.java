...
//        populateAutoComplete();
    ...
    private void doLogin(){
        ...
        final String loginURL = "https://mkart.herokuapp.com/driver/login/" + phone;

        JsonObjectRequest loginreq = new JsonObjectRequest(Request.Method.POST, loginURL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    editor.clear();
                    editor.putString("user_id", response.getString("_id"));
                    JSONObject vehicle = response.getJSONObject("vehicle_id");
                    String vehicle_id = vehicle.getString("_id");
                    JSONObject vehicleType = vehicle.getJSONObject("type");
                    String vehicle_type = vehicleType.getString("name");
        ...
        loginRequestQueue.add(loginreq);
    }
